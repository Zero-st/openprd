---
name: openprd-experience-diagnostic-candidate-eval-20260607125040
...
> 状态：draft
> 候选目录：`.openprd/knowledge/candidates/candidate-eval-20260607125040`
> Promote：`openprd quality . --learn --from .openprd/knowledge/candidates/candidate-eval-20260607125040`
...
- 任务场景: dev-check
- 相关文件: package-lock.json、package.json、src/agent-integration.js、src/brainstorm-artifacts.js、src/brainstorm-presentation.js、src/brainstorm.js
...
- 项目经验候选与诊断包
- 待确认的项目经验草案
- 验证结论: dev-check attention=5, warning=9
- 可复用的验证链路与收尾动作
...
- `src/brainstorm-presentation.js`
- `src/brainstorm.js`
- `src/cli/quality-print.js`
- `src/codex-hook-runner-template.mjs`
- `src/diagram-core.js`
- `src/html-artifacts.js`
- `src/knowledge.js`
- `src/prd-core.js`
- `src/quality-html-artifact.js`
- `src/quality.js`
...
- dev-check attention=5, warning=9

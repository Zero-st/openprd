---
name: openprd-experience-diagnostic-candidate-turn-1780815453337-a71a9bbe5cd97a98
...
# openprd-experience-diagnostic-candidate-turn-1780815453337-a71a9bbe5cd97a98

> 状态：draft
> 候选目录：`.openprd/knowledge/candidates/candidate-turn-1780815453337-a71a9bbe5cd97a98`
> Promote：`openprd quality . --learn --from .openprd/knowledge/candidates/candidate-turn-1780815453337-a71a9bbe5cd97a98`
...
- 项目经验候选与诊断包
- 待确认的项目经验草案
- 验证结论: run verify task-ready with workspace attention: feature-coverage ledger remains open
- 可复用的验证链路与收尾动作
...
- run verify task-ready with workspace attention: feature-coverage ledger remains open

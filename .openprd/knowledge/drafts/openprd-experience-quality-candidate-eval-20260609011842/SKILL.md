---
name: openprd-experience-quality-candidate-eval-20260609011842
...
# openprd-experience-quality-candidate-eval-20260609011842

> 状态：draft
> 候选目录：`.openprd/knowledge/candidates/candidate-eval-20260609011842`
> Promote：`openprd quality . --learn --from .openprd/knowledge/candidates/candidate-eval-20260609011842`
...
- dev-check: dev-check attention=2, warning=3 | touched: skills/openprd-router/SKILL.md, skills/openprd-frontend-design/SKILL.md, skills/openprd-harness/SKILL.md, skills/openprd-frontend-design/references/design-asset-contract.md, skills/openprd-frontend-design/references/direction-engine.md, src/run-harness.js
...
- dev-check: dev-check attention=2, warning=3 | touched: skills/openprd-router/SKILL.md, skills/openprd-frontend-design/SKILL.md, skills/openprd-harness/SKILL.md, src/run-harness.js, src/agent-integration.js, src/design-starter.js
...
- 相关文件: skills/openprd-router/SKILL.md、skills/openprd-frontend-design/SKILL.md、skills/openprd-harness/SKILL.md、skills/openprd-frontend-design/references/design-asset-contract.md、skills/openprd-frontend-design/references/direction-engine.md、src/run-harness.js
...
- `.openprd/quality/reports/eval-20260609011842.json`
...
- dev-check attention=0, warning=1

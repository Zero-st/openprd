---
name: openprd-experience-diagnostic-candidate-eval-20260609094734
...
# openprd-experience-diagnostic-candidate-eval-20260609094734
...
- 任务场景: dev-check
- 相关文件: scripts/openprd-codex-isolated-worker.mjs、src/codex-hook-runner-template.mjs、test/openprd.test.js
...
- 项目经验候选与诊断包
- 待确认的项目经验草案
- 验证结论: dev-check attention=1, warning=2
- 可复用的验证链路与收尾动作

---
name: openprd-experience-quality-candidate-eval-20260607125040
description: OpenPrd 在本轮回顾时自动生成的待确认项目经验草案。
---

# openprd-experience-quality-candidate-eval-20260607125040
...
- dev-check: dev-check attention=0, warning=4 | touched: src/workspace-workflow.js, src/codex-hook-runner-template.mjs, src/agent-integration.js, test/requirement-gate.test.js
...
- `.openprd/quality/reports/eval-20260607125040.json`

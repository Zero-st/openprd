---
name: openprd-experience-diagnostic-candidate-eval-20260609141448
...
# openprd-experience-diagnostic-candidate-eval-20260609141448
...
- 任务场景: dev-check
- 相关文件: src/knowledge.js、src/cli/quality-print.js
...
- 项目经验候选与诊断包
- 待确认的项目经验草案
- 验证结论: dev-check attention=0, warning=1
- 可复用的验证链路与收尾动作
